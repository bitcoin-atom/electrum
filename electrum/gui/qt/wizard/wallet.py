...
class WCWalletType(WizardComponent):
    def __init__(self, parent, wizard):
        ...
        wallet_kinds = [
            ...
            ('imported',  _('Import BitcoinAtom addresses or private keys')),
        ]
...
class WCImport(WizardComponent):
    def __init__(self, parent, wizard):
        WizardComponent.__init__(self, parent, wizard, title=_('Import BitcoinAtom Addresses or Private Keys'))
        message = _(
            'Enter a list of BitcoinAtom addresses (this will create a watching-only wallet), or a list of private keys.')
